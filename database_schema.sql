...
CREATE TABLE "skill_knowledge_bases" (
...
CREATE INDEX skills_llm_provider_config_idx ON skills(llm_provider_config_id);
CREATE INDEX skills_collection_name_idx ON skills(collection_name);
CREATE INDEX skill_knowledge_bases_workspace_idx ON skill_knowledge_bases(workspace_id);
CREATE INDEX skill_knowledge_bases_knowledge_base_idx ON skill_knowledge_bases(knowledge_base_id);
